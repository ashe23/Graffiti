...
namespace Graffiti {
    ...
    Mesh Model::processMesh(aiMesh *mesh, const aiScene *scene) {
        ...
        // TODO:Ashe23 should check for correct normals,tangents , sometimes Access Violation Error occured when loading model
        ...
        if (mesh->mMaterialIndex >= 0) {
            ...
            std::cout << "Materials count:" << diffuseMaps.size() << std::endl;
        }
